...
import $ from 'jquery'
import iziToast from './assets/javascripts/iziToast.min'
...
//app.$mount('#app')
console.log("----------")
//App.components.GameTable.props.field = field;
console.log("----------")
//console.log(App.components.GameTable.props.field)
console.log("++++++++++++++")
...
$(document).ready(async function() {
  ...
  $.ajax({
    ...
    success: function (data)  {
      ...
      console.log("VOR ++++++++++++++")
      console.log(App.components.GameTable.props.field)
      App.components.GameTable.props.field = jsonData.field;
      //App.data().field = jsonData.field

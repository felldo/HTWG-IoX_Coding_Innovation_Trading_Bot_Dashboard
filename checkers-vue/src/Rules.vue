<template>
  <div id="gamerules">
    ...
    <p>
      ...
      When presented, capturing is mandatory in most official rules, although some rule variations make capturing optional.[3] In almost all variants, the player without pieces remaining, or who cannot move due to being blocked, loses the game.
    </p>
    ...
    <div id="pictures">
      ...
      <div class="row">
        <div class="col">
          ...
          <img src="@routes.Assets.versioned("images/tui.jpg")" alt="TextUI in standalone application" height="300"/>
        </div>
        <div class="col">
          <div>GUI</div>
          <img src="@routes.Assets.versioned("images/gui.gif")" alt="GUI in standalone application" height="300"/>
        </div>
        <div class="col"></div>
      </div>
